...
def configure_request(app):
    global apiKey, sources_url, articles_url, topheadlines_url, everything_url, everything_search_url
...
def topheadlines(limit):
    ...
    Function that gets articles based on the source id
    """
    get_topheadlines_url = topheadlines_url.format(limit, apiKey)
...
def search_everything(limit, query):
    ...
    """
    search_everything_url = everything_search_url.format(query, limit, apiKey)
